          ...
          data.map(item =>
            item.children ? (
              <div key={item.text}>
                ...
                <Popper
                  open={!!this.state.menuStatusSet[this.getMenuKey(item)]}
                  anchorEl={this.anchors[this.getMenuKey(item)]}
                  transition={true}
                  disablePortal={true}
                >
                  {({ TransitionProps, placement }) => (
                    ...
                    >
                      <Paper square={true}>
                        <ClickAwayListener
                          onClickAway={e => this.handleClose(e, item)}
                        >
          ...
          {menu.children.map(subItem => (
            <div key={subItem.text} className={classes.subMenuWrapper}>
              <MenuItem
                ...
                component={props => this.menuItem(props, subItem, false)}
              />
